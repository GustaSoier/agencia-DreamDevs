...
<div class="cartao">
  ...
  <div class="code">
  <img src="img/Dream Devsll.png" class="imagem">
<g>
  <g>
...
<g>
  ...
  <ul>
          <li><a href="#">(11)9888-99898</a></li>
          <li><a href="#">dreamdevs481@gmail.com</a></li>
        ...
        <div class="sobre">
          <h3>Sobre nós</h3>
          <p>Nós somos a Dream Devs, uma empresa de desenvolvimento web que busca realizar os melhores sites com as melhores tecnologias para que seu site seja intuitivo e e objetivo, com responsividae de qualidade e acessibilidade tambem! </p>
        </div>
        </section>
